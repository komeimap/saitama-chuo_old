        var map = L.map('map').setView([35.883900, 139.626195], 13);
        ...
        function detail(link) {
            if (link.length == 0) {
                ...
                return '</br><a id="syousai" href="' + link + '" onclick="window.open(this.href); return false;"></a>'
            };
        }
                ...
                var circle = g.selectAll('circle')
                    ...
                    .on('click', function(d) {
                        ...
                        div.html('<input type="image" style="position: absolute; right: 2%;" src="images/close.png" alt="" onClick="closeTooltip();">' +
                            ...
                            d.Result + '</b></td></tr>' +
                            '<tr><td width="50%" height="200px"><a href="images/' + d.Image +
